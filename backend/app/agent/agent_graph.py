...
class BasicToolNode:
    ...
    try: 
        ...
        def __call__(self, inputs: dict):
            ...
            logger.info(f"Tool calling success output : 'messsage' : {outputs}")
            return {"messages": outputs}
    except Exception as e:
        logger.info(f"Exception occure at agent Basic toolnode : {str(e)}")
...
def route_tools(
    ...
    """
    try: 
        logger.info("Tool routing started")
        ...
        logger.info(f"Exception occure during agent tool routing : {str(e)}")
        raise CustomException(e, sys)
...
try: 
    ...
    logger.info(f"Exception occure during graph creation : {str(e)}")
    raise CustomException(e, sys)
